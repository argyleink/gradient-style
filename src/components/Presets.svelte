<script>
	...
	const presets = [
		...
		},
		{
			...
			stops: [
				{color: '#fff'},
				{kind: 'hint', auto: null, percentage: '11'},
				{color: '#000', position1: '0', position2: '20'},
				{kind: 'hint', auto: null, percentage: '31'},
				{color: '#fff', position1: '0', position2: '40'},
				{kind: 'hint', auto: null, percentage: '51'},
				{color: '#000', position1: '0', position2: '60'},
				{kind: 'hint', auto: null, percentage: '71'},
				{color: '#fff', position1: '0', position2: '80'},
				{kind: 'hint', auto: null, percentage: '91'},
